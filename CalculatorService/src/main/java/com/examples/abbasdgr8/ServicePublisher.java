...
* SIB is {@link com.examples.abbasdgr8.CalculatorServiceInterface}. 
...
* publication path is /calc, an arbitrary name.
*
...
* com.examples.abbasdgr8.CalculatorServiceInterface.
*
...
public class ServicePublisher {
    ...
    public static void main(String[] args) {
        ...
        Endpoint.publish("http://127.0.0.1:9876/calc", new CalculatorServiceImplementation());
    }
